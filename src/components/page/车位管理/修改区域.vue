<template>
	<div>
		<el-form class="main" :model="form" >
					...
					<el-form :model="form.info" :label-position="labelPosition" label-width="120px">
						<div class="left">
							<el-form-item label="区域名称 :">
		    					<el-input v-model="form.info.name" placeholder="请输入级别名称" style="width: 400px;"></el-input>
							</el-form-item>
							...
							<el-form-item label="开盘时间 :">
								...
								<el-date-picker v-model="form.info.openEndTime" type="datetime" placeholder="选择日期时间" v-show="false"></el-date-picker>
						...
						<div class="right">
							<el-form-item label="级别编号 :">{{form.info.code}}</el-form-item>
						</div>	
					</el-form>
				</div>
			</div>
			<!--车位展示信息管理-->
			<div class="info">
				<div class="title"><span class="f1"></span>车位展示信息管理</div>
				<div class="ff1">
					<el-form :model="form.info" :label-position="labelPosition" label-width="120px">
						<div class="leftOne">
							<el-form-item label="此级别车位总数 :" style="width: 50%;float: left;">{{form.info.areaCarCount}}个</el-form-item>
			...
			<div class="info" v-if="false">
				...
				<div class="ff1">
					<el-form :model="form.info" :label-position="labelPosition" label-width="120px">
						<el-form-item label="区域车位图 :"style="margin-left: 10px;">
							<div class="pic-box">
	...
	export default{
		...
		data(){
	  	...
	  	created(){
	  		...
	  		this.$axios.get(request.testUrl+"/product/auth1/truckSpaceArea/selectOne",{
					params:{
						areaId:this.id,
					}
			}).then(res=>{
				if(res.data.code==0){
					...
					this.form.info.timeFollowOpenTime=this.form.info.timeFollowOpenTime==1
				}
	  	...
	  	methods:{
	        ...
	        save(){
	        	...
	        	this.$axios({
		        	method:'post',
		        	url:request.testUrl+"/product/auth1/truckSpaceArea/doUpdate",
		        	data:{
