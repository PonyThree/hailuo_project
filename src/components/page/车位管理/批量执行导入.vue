			...
			<div class="ff1">
				...
				<div style="width: 68%;margin: 20px auto;">
					...
					<el-table :data="tableInfo" border style="width:91.5%;margin: 0 auto;">
						<el-table-column type="index" label="行数" width="150" align="center"></el-table-column>
						<el-table-column prop="name" label="车位编号" width="250" align="center"></el-table-column>
						<el-table-column prop="location" label="车位位置" align="center" width="250"></el-table-column>
						<el-table-column prop="error" label="错误提示 " align="center" width="350" class="last">
						</el-table-column>
					</el-table>
...
<script>
	export default{
	    ...
	    created(){
	    	this.$axios.post(request.testUrl+"/product/auth1/truckSpace/getImportExcelSelect")
        		.then(res=>{
