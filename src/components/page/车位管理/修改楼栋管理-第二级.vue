	...
	<div>
		<el-form class="main" :model="form" >
					...
					<el-form :model="form.info" :label-position="labelPosition" label-width="120px">
						<div class="left">
							<el-form-item label="楼层名称 :">
		    					<el-input v-model="form.info.name" placeholder="请输入车位楼层名称" style="width: 400px;"></el-input>
							</el-form-item>
			...
			<div class="info"  v-if="false">
				...
				<div class="ff1">
					<el-form :model="form.info" :label-position="labelPosition" label-width="120px">
						<el-form-item label="楼层车位图 :"style="margin-left: 10px;">
							<div class="pic-box">
	...
	export default{
		...
		data(){
	  	...
	  	methods:{
	        ...
	        //保存
	        save(){
	        	if(this.form.info.openEndTime<this.form.info.openStartTime){
	        		this.$message({
						type: 'info',
