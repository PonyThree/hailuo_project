<template>
	<div>
		<el-form :model="form" class="chess" :label-position="labelPosition" label-width="120px">
			<div style="width: 40%;float: left;">
				<!--<el-form-item label="订单编号:" style="width: 600px;float: left;">
					<el-input v-model="form.orderNo" placeholder="订单编号" style="width: 200px;"></el-input>
	           	</el-form-item>-->
		...
		<div class="table">
			<!--表格-->
			<el-table :data="tableList" border style="width:62%;margin: 0 auto;" :header-cell-style="{background:'#dcd3ef',color:'#606266'}"  header-row-class-name="tableHead">
				<el-table-column type="index" label="序号" align="center" width="60" ></el-table-column>
				<el-table-column prop="userId" v-show:"false"></el-table-column>
				<el-table-column prop="name" label="用户名" align="center"></el-table-column>
				<el-table-column prop="mobile" label="联系电话" align="center"></el-table-column>
				<el-table-column prop="freezeMoney" label="冻结金额" align="center"></el-table-column>
	...
	export default{
	    ...
	    methods:{
	    	...
	    	check(currentPage){
	    		...
	    		this.$axios({
			    	method:'post',
			    	url:request.testUrl+"/user/auth1/userProjectUseMoney/findFreezeListByProjectId",
			    	data:{
