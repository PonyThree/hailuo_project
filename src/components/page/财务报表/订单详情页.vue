<template>
	<div>
		...
		<el-table :data="tableData" border style="width: 90%;margin: 30px auto;" :header-cell-style="{background:'#dcd3ef',color:'#606266'}"  header-row-class-name="tableHead">
			...
			<el-table-column prop="orderNo" label="订单编号" width="154" align="center"></el-table-column>
			<el-table-column prop="submitTime" label="提交时间" width="200" align="center"></el-table-column>
			...
			<el-table-column prop="money" label="支付金额" align="center" width="170"></el-table-column>
			<el-table-column prop="payWayName" label="支付方式" align="center" width="140"></el-table-column>
